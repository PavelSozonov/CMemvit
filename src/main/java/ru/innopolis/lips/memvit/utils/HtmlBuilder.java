...
public class HtmlBuilder {
	...
	private String activationRecordTemplate = "<div class=\"ar collapsibleList\"><div class=\"ar_title\">Activation Record</div><table class=\"ar_info\"> <tr> <td class=\"n\">Function</td><td class=\"v\">%s</td></tr><tr> <td class=\"n\">File</td><td class=\"v\">%s</td></tr><tr> <td class=\"n\">Line</td><td class=\"v\">%s</td></tr><tr> <td colspan=\"2\"> <table class=\"ar_vars\"> <thead> <tr class=\"title\"> <td>Address</td><td>Type</td><td>Name</td><td>Value</td></tr></thead> <tbody> <tr> <td>%s</td><td colspan=\"3\" class=\"gr\">end address</td></tr>%s</tbody> </table> </td></tr></table></div>";

	// Template's params list: addr, type, name, value
	private String varsRowTemplate = "<tr> <td class=\"c_addr\">%s</td><td class=\"c_type\">%s</td><td class=\"c_name\">%s</td><td class=\"c_value\">%s</td></tr>";
	private String argsRowTemplate = "<tr> <td class=\"c_addr arg\">%s</td><td class=\"c_type arg\">%s</td><td class=\"c_name arg\">%s</td><td class=\"c_value arg\">%s</td></tr>";

	// Template's params list: addr, type, UNIQUE ID, name, value
	private String varsRowWithNestedTemplate = "<tr> <td class=\"c_addr\">%s</td><td class=\"c_type\">%s</td><td class=\"c_name\">%s</td><td class=\"c_value\"><label for=\"mln%s\">%s</label></td></tr>";

	private String varsTableHeader = "<table class=\"ar_vars\"> <thead> <tr class=\"title\"> <td>Address</td><td>Type</td><td>Name</td><td>Value</td></tr></thead> <tbody>";
	private String varsTableFooter = "</tbody></table>";
	...
	public String composeBrowserView(State state) {
		...
		html = composeHtml(frames, eaxType, eaxValue, heapVars);
		return html;
	}
	...
	private String composeHtml(ActivationRecord[] frames, String eaxType, String eaxValue, VarDescription[] heapVars) {
