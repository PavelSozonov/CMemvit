...
public class JsonUtils {
	 ...
	 */
	public static String buildJson(ActivationRecord[] stack, VarDescription[] heap,
	...
	private static ActivationRecord jsonFrameProcessing(JSONObject frame) {
		...
		ActivationRecord record = new ActivationRecord(frame.getString("lineNumber"), frame.getString("functionName"),
				...
				staticLink, processingVars(frame.getJSONArray("vars")), processingVars(frame.getJSONArray("args")));
